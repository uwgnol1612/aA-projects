...
class MetaCorgiSnacks
  ...
  #   # Your code goes here...
  #   method1_name = "get_" + "#{name}" + "_tastiness"
  #   method2_name = "get_" + "#{name}" + "_info"
  #   info = @snack_box.send("#{method2_name}".to_sym, @box_id)
  #   tastiness = @snack_box.send("#{method1_name}".to_sym, @box_id)
