...
class MinMaxStack {
    ...
    push(val) {
        ...
        if (!this.minNodes.length || newNode.value <= this.minNodes[this.minNodes.length - 1].value) {
            this.minNodes.push(newNode);
        }

        if (!this.maxNodes.length || newNode.value >= this.maxNodes[this.maxNodes.length - 1].value) {
    ...
    pop() {
        ...
        if (this.top.value === this.maxNodes[this.maxNodes.length - 1].value) {
            this.maxNodes.pop();
        }

        if (this.top.value === this.minNodes[this.minNodes.length - 1].value) {
            this.minNodes.pop();
        }
